...
export default function App() {
  ...
  const handleNew = () => { setMessages([]); setConversationId(null) }
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        <Sidebar activeId={conversationId} onSelect={handleSelectConversation} onNew={handleNew} refreshTrigger={sidebarRefresh} />
