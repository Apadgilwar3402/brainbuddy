  ...
  if (!data) {
    ...
    return (
      ...
      >
        ...
        >
          Type an engineering concept and I'll break it down like you're 5 years
          old
        </p>
      </div>
    );
    ...
    >
      ...
      <Section tag="Explanation" tagColor="var(--yellow)" icon="💡">
        {data.explanation?.trim() && (
          <Section icon="💡" title="Explanation">
            <MarkdownRenderer content={data.explanation} />
          </Section>
        )}
      </Section>

      <Section tag="Table" tagColor="var(--cyan)" icon="📊">
        {data.table?.length > 0 && (
          <Section icon="📊" title="Comparison Table">
